...
var _react = _interopRequireDefault(__webpack_require__(2608));
...
var React = _interopRequireWildcard(__webpack_require__(2608));
...
var _react = __webpack_require__(2608);
...
exports.components={"component---cache-caches-gatsby-plugin-offline-app-shell-js":()=>__webpack_require__.e(/* import() | component---cache-caches-gatsby-plugin-offline-app-shell-js */ 306).then(__webpack_require__.bind(__webpack_require__, 1367)),"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 883).then(__webpack_require__.bind(__webpack_require__, 429)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 678).then(__webpack_require__.bind(__webpack_require__, 8298)),"component---src-pages-page-2-js":()=>__webpack_require__.e(/* import() | component---src-pages-page-2-js */ 617).then(__webpack_require__.bind(__webpack_require__, 4948))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(1674),options:{"plugins":[]}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(5822),options:{"plugins":[],"name":"gatsby-starter-default","short_name":"Matts Portfolio","start_url":"/","background_color":"#663399","theme_color":"#663399","display":"minimal-ui","icon":"src/images/theBestFavicon.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"f04b8505dec71b59361bc2294ff30571"}},{name:'gatsby-plugin-crisp-chat',plugin:__webpack_require__(1813),options:{"plugins":[],"websiteId":"1970d31a-f3ed-4127-b8af-ffd26c2e82c9","enableDuringDevelop":true,"defer":true,"enableImprovedAccessibility":false}},{name:'gatsby-plugin-offline',plugin:__webpack_require__(8379),options:{"plugins":[]}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2608);
...
// EXTERNAL MODULE: external "/home/rthsa/Documents/Projects/Personal-Portfolio-Copy/node_modules/react/index.js"
var index_js_ = __webpack_require__(2608);
...
"use strict";
var _react=_interopRequireDefault(__webpack_require__(2608));function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}/* eslint-disable import/no-unresolved */function getAsyncOrDefer(isDefer){return isDefer?'s.defer=1':'s.async=1';}exports.onRenderBody=({setHeadComponents},{websiteId,enableDuringDevelop=true,defer=false})=>{if(!enableDuringDevelop&&"production"==='development'){}if(!websiteId){console.log('You have not provided websiteId, gatsby-plugin-crisp-chat will not take effect.');return null;}const scriptInnerHTML=`window.$crisp=[];window.CRISP_WEBSITE_ID="${websiteId}";`+`(function(){d=document;s=d.createElement("script");`+`s.src="https://client.crisp.chat/l.js";`+`${getAsyncOrDefer(defer)};`+`d.getElementsByTagName("head")[0].appendChild(s);})();`;return setHeadComponents([_react.default.createElement("script",{key:"gatsby-plugin-crisp-chat",dangerouslySetInnerHTML:{__html:scriptInnerHTML}})]);};
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);var React=_interopRequireWildcard(__webpack_require__(2608));var _gatsby=__webpack_require__(7533);var _common=__webpack_require__(5428);var _getManifestPathname=_interopRequireDefault(__webpack_require__(292));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2608);
...
var React = __webpack_require__(2608);
...
"use strict";
module.exports = require("/home/rthsa/Documents/Projects/Personal-Portfolio-Copy/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/home/rthsa/Documents/Projects/Personal-Portfolio-Copy/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/home/rthsa/Documents/Projects/Personal-Portfolio-Copy/node_modules/react/index.js");
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-c4dca58eb97fb4464853.js"],"app":["/app-400d621b01d1939d7ed2.js"],"component---cache-caches-gatsby-plugin-offline-app-shell-js":["/component---cache-caches-gatsby-plugin-offline-app-shell-js-bb299959a3531fa05e2e.js"],"component---src-pages-404-js":["/component---src-pages-404-js-9a3b537c18039da87098.js"],"component---src-pages-index-js":["/component---src-pages-index-js-4c3e8f8be4b1e0544d96.js"],"component---src-pages-page-2-js":["/component---src-pages-page-2-js-e1b98911cc42cb401c72.js"]}');
...
/* harmony export */ });
/* global HAS_REACT_18 */const React=__webpack_require__(2608);const path=__webpack_require__(1423);const{renderToString,renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(92);const{ServerLocation,Router,isRedirect}=__webpack_require__(3631);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(7533);const fs=__webpack_require__(6528);const{WritableAsPromise}=__webpack_require__(5897);const{RouteAnnouncerProps}=__webpack_require__(236);const{apiRunner,apiRunnerAsync}=__webpack_require__(4067);const asyncRequires=__webpack_require__(5418);const{version:gatsbyVersion}=__webpack_require__(1741);const{grabMatchParams}=__webpack_require__(9755);const chunkMapping=__webpack_require__(9804);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
